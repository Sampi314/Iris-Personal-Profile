...
function initContactForm() {
    ...
    form.addEventListener('submit', (e) => {
        ...
        const mailtoLink = `mailto:irisphan314@gmail.com?subject=${encodeURIComponent(subject || 'Website Contact')}&body=${encodeURIComponent('From: ' + name + ' (' + email + ')\n\n' + message)}`;
...
function initParticleCanvas(canvas) {
    ...
    const layers = [
        { particles: [], speed: 0.12, size: [0.5, 1.2], alpha: [0.15, 0.3],  lineAlpha: 0.08, lineDist: 100, parallax: 0.02, color: '212, 115, 157' },
        { particles: [], speed: 0.25, size: [1.0, 2.2], alpha: [0.35, 0.6],  lineAlpha: 0.18, lineDist: 130, parallax: 0.05, color: '212, 115, 157' },
        { particles: [], speed: 0.45, size: [1.8, 3.5], alpha: [0.55, 0.85], lineAlpha: 0.30, lineDist: 160, parallax: 0.10, color: '212, 115, 157' },
    ];
...
function getSNLogoSVG(size) {
    ...
    return '<svg width="' + size + '" height="' + size + '" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">' +
        ...
        '<text x="16" y="22" text-anchor="middle" font-family="\'Space Mono\', monospace" font-size="14" font-weight="700" fill="currentColor">IP</text>' +
    '</svg>';
}
